    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            ...
            <div className="relative mt-10 md:mt-24 md:order-2">
                ...
                <div className="relative grid max-w-lg flex-column flex-md-row flex-lg-row grid-cols-1 d-flex gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                    <div className="d-flex flex-column flex-md-row flex-lg-row px-4 overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                <div className="d-flex align-items-center justify-content-center flex-row items-center">
                                    <svg className="my-svg h-5 text-[#FDB241]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path
