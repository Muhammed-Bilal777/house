        ...
        <div className=" flex-column  flex-md-row   card-group d-flex justify-content-around gap-5 ">
          <div className="card border-0 h-75 ">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                This is a wider room for single person with three waredrobe, one
                chair and one table.
              </p>
              <Link to="/single" type="button" class="btn btn-danger">
                Single Sharing
              </Link>
            </div>
          </div>
          <div className="card  border-0 ">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                This is a wider room for two persons with three waredrobe, one
          ...
          <div className="card border-0   ">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                This is a wider and large room for persons with three waredrobe,
                one chair and two tables.
              </p>
              <Link to="/single" type="button" class="btn btn-danger">
                Three Sharing
              </Link>
